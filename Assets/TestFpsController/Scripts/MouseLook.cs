...
public class MouseLook : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //     W means forward motion (vector3.forward) so we want to player to rotate towards where the head is pointing to maintain that forward motion
        //     Else the character would only move forward in WORLD SPACE
        //     We dont rotate the head on the Y axis since the BODY is being rotated on it -> else we would get double rotational values
